...
// Diagnostic statement code system OID (Fukuda INTER12L statement vocabulary).
// Fukuda INTER12L interpretive-statement vocabulary (proprietary code set).
const statementCodeSystem = "1.2.392.200070.77706983"
