...
var labelsFR = labels{
	...
	disclaimer: "Document généré automatiquement par conversion — non certifié à usage médical. " +
		"Ne pas utiliser à des fins diagnostiques. Se référer au tracé original de l'appareil.",
}
...
var labelsEN = labels{
	...
	disclaimer: "Automatically generated by conversion — not medically certified. " +
		"Not for diagnostic use. Refer to the original device recording.",
}
